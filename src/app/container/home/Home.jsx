              ...
              <div className={Style.oneBlock} key={i+1}>
                <div className={Style.block}>
                  <div className={Style.info}>
                    ...
                    <Link href={{pathname: '/block', query: el[0].number}}>
                      {el[0].number}
                    </Link>
                  </div>
                  <p>{el[0].timestamp}</p>
                ...
                <div>
                  <div className={Style.miner}>
                    <p>
                      <samp>Miner: &nbsp;&nbsp; 
                        <Link className={Style.link} href={{pathname: '/account/', query: el[0].miner}} legacyBehavior>
                          <a>{el[0].miner.slice(0, 35)}</a>
                        </Link>
                      </samp>
                    </p>
                    <span>
                    <Link className={Style.link} href={{pathname: '/account/', query: el[0].number}} legacyBehavior>
